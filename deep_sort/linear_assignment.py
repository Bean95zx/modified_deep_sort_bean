...
def gate_cost_matrix(  # 这里进来的cost_matrix已经是算好的了
    ...
    # measurement是（中心点x,y,纵横比，高度）  to_xyah()方法
    ...
    for row, track_idx in enumerate(track_indices):
        ...
        # print("gated_cost", gated_cost)
        # print("gating_distance", gating_distance)
        # print("gating_threshold", gating_threshold)

        # 判断gating_distance是否大于gating_threshold，如果是就将gated_cost放入
